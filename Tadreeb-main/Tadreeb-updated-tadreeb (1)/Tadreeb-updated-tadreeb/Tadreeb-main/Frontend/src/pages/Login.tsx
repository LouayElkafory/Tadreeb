  ...
  return (
    <div className="min-h-[calc(100vh-88px)] flex items-center justify-center px-5 py-16 bg-baby-blue/30">
      <div className="w-full max-w-md bg-white rounded-3xl border border-soft-blue shadow-[0_10px_40px_rgba(16,43,87,0.08)] p-8 sm:p-10">
        ...
        <h1 className="text-xl font-extrabold text-deep-navy text-center mb-1.5">{t("login.title")}</h1>
        <p className="text-sm text-text-secondary text-center mb-8">{t("login.body")}</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="block text-xs font-semibold text-text-secondary mb-1.5">{t("login.email")}</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-text-secondary mb-1.5">{t("login.password")}</label>
            <div className="relative">
        ...
        <p className="text-center text-xs text-text-secondary mt-6">
          {t("login.noAccount")}{" "}
          <button className="text-primary font-semibold hover:underline">{t("login.signup")}</button>
        </p>
